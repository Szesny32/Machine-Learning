...
best_exam_time_studied_train, best_exam_time_studied_test, best_exam_score_train, best_exam_score_test = train_test_split(exam_time_studied, exexam_scores, test_size=0.4)


best_model = LinearRegression()
best_model.fit(best_exam_time_studied_train, best_exam_score_train)
best_score = best_model.score(best_exam_time_studied_test, best_exam_score_test) * 100
...
for i in range(1,10000):
    ...
    if score > best_score :
        best_score = score
        best_model = model
        best_exam_time_studied_train = exam_time_studied_train
        best_exam_time_studied_test = exam_time_studied_test
        best_exam_score_train = exam_score_train
        best_exam_score_test = exam_score_test
    print(i, score, "%")


plt.scatter(best_exam_time_studied_train, best_exam_score_train)
plt.ylim(0,100)
plt.title("Base data")
plt.show()
...
print("Test data: ", best_exam_time_studied_test)
print("Predict values: ", best_model.predict(best_exam_time_studied_test))
print("True values: ", best_exam_score_test)
